...
const BottomModelComponent = ({ visible, onClose, locations, onLocationSelect }) => {
        ...
        <SafeAreaView>
          <ScrollView style={{ paddingBottom: 80 }}>
            ...
            <View style={{ justifyContent: 'space-between', flexDirection: 'row', paddingBottom: 8 }}>
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate('My Address', { locations });  // Passing locations here
          ...
          >
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate('New Address', { locations });
                onClose();  // Close modal after navigating
              }}
            >
